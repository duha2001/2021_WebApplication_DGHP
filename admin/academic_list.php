...
<script>
    $(document).ready(function() {
        $('.new_academic').click(function() {
            uni_modal("Thêm khóa học", "<?php echo $_SESSION['login_view_folder']; ?>manage_academic.php")
        })
        $('.manage_academic').click(function() {
            uni_modal("Chỉnh sửa khóa học", "<?php echo $_SESSION['login_view_folder']; ?>manage_academic.php?id=" + $(this).attr('data-id'))
        })
