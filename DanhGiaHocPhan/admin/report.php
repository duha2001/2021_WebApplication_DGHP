...
<div class="col-lg-12">
	<div class="callout callout-info">
		<div class="d-flex w-100 justify-content-center align-items-center">
			<label for="faculty">Chọn GV</label>
	...
	<div class="row">
		...
		<div class="col-md-9">
			...
			<table width="100%">
					<tr>
						<td width="50%"><p><b>Tên giảng viên: <span id="fname"></span></b></p></td>
			...
			success:function(resp){
				if(resp){
					...
					if(Object.keys(resp).length <= 0 ){
						$('#class-list').html('<a href="javascript:void(0)" class="list-group-item list-group-item-action disabled">Không có dữ liệu hiển thịs.</a>')
					}else{
						$('#class-list').html('')
